...
This mechanism has been integrated into Bitcore-Node-SWI which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/swincacoin/insight-api-swi#web-socket-api](https://github.com/swincacoin/insight-api-swi#web-socket-api) 
* API: [https://github.com/swincacoin/insight-api-swi#swifttx-transactions](https://github.com/swincacoin/insight-api-swi#swifttx-transactions) 
...
By default, the SWI Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the SWI Core daemon:
