...
In order to support loading of multiple wallets in swi-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is swi.cpp.
...
Changes to swi.cpp
----------------------
swi.cpp is the entry point into swi-qt, and as such, will require some minor modifications to provide hooks for
