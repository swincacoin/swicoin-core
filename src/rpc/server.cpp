...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* SWI features */
        {"swi", "masternode", &masternode, true, true, false},
        {"swi", "listmasternodes", &listmasternodes, true, true, false},
        {"swi", "getmasternodecount", &getmasternodecount, true, true, false},
        {"swi", "masternodeconnect", &masternodeconnect, true, true, false},
        {"swi", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"swi", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"swi", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"swi", "masternodecurrent", &masternodecurrent, true, true, false},
        {"swi", "masternodedebug", &masternodedebug, true, true, false},
        {"swi", "startmasternode", &startmasternode, true, true, false},
        {"swi", "createmasternodekey", &createmasternodekey, true, true, false},
        {"swi", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"swi", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"swi", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"swi", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"swi", "getmasternodescores", &getmasternodescores, true, true, false},
        {"swi", "mnbudget", &mnbudget, true, true, false},
        {"swi", "preparebudget", &preparebudget, true, true, false},
        {"swi", "submitbudget", &submitbudget, true, true, false},
        {"swi", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"swi", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"swi", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"swi", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"swi", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"swi", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"swi", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"swi", "checkbudgets", &checkbudgets, true, true, false},
        {"swi", "mnsync", &mnsync, true, true, false},
        {"swi", "spork", &spork, true, true, false},
        {"swi", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzswiseed", &getzswiseed, false, false, true},
        {"zerocoin", "setzswiseed", &setzswiseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzswi", &searchdzswi, false, false, true},
        {"zerocoin", "dzswistate", &dzswistate, false, false, true}
...
{
    return "> swi-cli " + methodname + " " + args + "\n";
}
