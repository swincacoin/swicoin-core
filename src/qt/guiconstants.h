...
/* Swi GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "SWI"
#define QAPP_ORG_DOMAIN "swi.org"
#define QAPP_APP_NAME_DEFAULT "SWI-Qt"
#define QAPP_APP_NAME_TESTNET "SWI-Qt-testnet"
