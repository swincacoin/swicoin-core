                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzSWIPathCustom = GetArg("-zswibackuppath", "");
    ...
    if(!strzSWIPathCustom.empty()) {
        ui->wallet_customzswibackuppath->setText(QString::fromStdString(strzSWIPathCustom));
        ui->wallet_customzswibackuppath_label->setVisible(true);
        ui->wallet_customzswibackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzSWIPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the SWI RPC console.") + "<br>" +
