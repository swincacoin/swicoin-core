...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 46922;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // SWI starting difficulty is 1 / 2^12
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // SWI: 1 day
        nTargetSpacing = 1 * 60;  // SWI: 1 minute
        nMaturity = 100;
        nMasternodeCountDrift = 20;
        nMaxMoneyOut = 400000000 * COIN;

        /** Height or Time Based Activations **/
        nLastPOWBlock = 400; // PoW Phase max supply = 100,000 SWI
        ...
        nBlockZerocoinV2 = 1; //!> Always active
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "SWINCA, Real-Estate";
        ...
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "swi.seed.fuzzbawls.pw"));     // Primary DNS Seeder from Fuzzbawls
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "swi.seed2.fuzzbawls.pw"));    // Secondary DNS Seeder from Fuzzbawls
        ...
        nZerocoinRequiredStakeDepth = 200; //The required confirmations for a zswi to be stakable
...
public:
    CTestNetParams()
    {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "swi-testnet.seed.fuzzbawls.pw"));
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "swi-testnet.seed2.fuzzbawls.pw"));
        vSeeds.push_back(CDNSSeedData("s3v3nh4cks.ddns.net", "s3v3nh4cks.ddns.net"));
        vSeeds.push_back(CDNSSeedData("88.198.192.110", "88.198.192.110"));

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet swi addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet swi script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet swi BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet swi BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet swi BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // SWI: 1 day
        nTargetSpacing = 1 * 60;        // SWI: 1 minutes
