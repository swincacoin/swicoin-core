...
#   c) node1 mines 32 blocks, so now node 0 has 60001swi, node 1 has 4250swi, node2 has none.
#   d) node0 sends 601 swi to node2, in two transactions (301 swi, then 300 swi).
