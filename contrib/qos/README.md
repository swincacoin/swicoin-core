...
This means one can have an always-on swid instance running, and another local swid/swi-qt instance which connects to this node and receives blocks from it.
