...
RESOURCES += src/qt/swi.qrc src/qt/swi_locale.qrc

TRANSLATIONS += src/qt/locale/swi_bg.ts \
                src/qt/locale/swi_de.ts \
                src/qt/locale/swi_en.ts \
                src/qt/locale/swi_es.ts \
                src/qt/locale/swi_fi.ts \
                src/qt/locale/swi_fr.ts \
                src/qt/locale/swi_it.ts \
                src/qt/locale/swi_ja.ts \
                src/qt/locale/swi_pl.ts \
                src/qt/locale/swi_pt.ts \
                src/qt/locale/swi_ru.ts \
                src/qt/locale/swi_sk.ts \
                src/qt/locale/swi_sv.ts \
                src/qt/locale/swi_vi.ts \
                src/qt/locale/swi_zh_CN.ts \
                src/qt/locale/swi_zh_TW.ts
