Contributing to SWI Core
============================

The SWI Core project operates an open contributor model where anyone is
...
The following applies to code changes to the SWI Core project, and is not to be
confused with overall SWI Network Protocol consensus changes.

Whether a pull request is merged into SWI Core rests with the project merge
...
Patches that change SWI consensus rules are considerably more involved than
...
Where a patch set proposes to change the SWI consensus, it must have been
...
The project leader is the release manager for each SWI Core release.
